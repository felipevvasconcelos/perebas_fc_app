                ...
                children: [
                  ...
                  DropdownButtonFormField(
                    ...
                    items: const <DropdownMenuItem>[
                      ...
                      DropdownMenuItem(value: '3', child: Text('Volante')),
                      DropdownMenuItem(value: '4', child: Text('Meia')),
                      DropdownMenuItem(value: '5', child: Text('Ala')),
                      DropdownMenuItem(value: '6', child: Text('Atacante')),
                    ],
                  ),
                  const SizedBox(height: 10),
                  TextFormField(
